<?php
/**
 * File: src/class-wpdtrt-table-rewrite.php
 *
 * Rewrite sub class.
 *
 * Since:
...
/**
 * Class: WPDTRT_Table_Rewrite
 *
 * Extends the base class to inherit boilerplate functionality, adds application-specific methods.
 */
class WPDTRT_Table_Rewrite extends DoTheRightThing\WPDTRT_Plugin_Boilerplate\r_1_7_17\Rewrite {
